...
import 'package:transfer_news/Pages/Standings/IWLStandings.dart';
import 'package:transfer_news/Widgets/StatsWidget.dart';
import 'dart:convert';

import 'package:transfer_news/Widgets/fixturecard.dart';

class IWLCallback extends StatefulWidget {
  @override
  _IWLCallbackState createState() => _IWLCallbackState();
}

class _IWLCallbackState extends State<IWLCallback>
    with AutomaticKeepAliveClientMixin<IWLCallback> {
  List allFixtures;

  Future<String> getAllFixtures() async {
    var response = await http.get(
      "https://www.the-aiff.com/api/competition/fixtures/11",
    );
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            IWLStandings(),
            StatsWidget(
              url: "https://www.the-aiff.com/api/competition/stats/11",
            ),
          ],
        ),
      ),
