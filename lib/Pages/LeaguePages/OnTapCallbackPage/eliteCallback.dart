...
import 'package:transfer_news/Pages/Standings/EliteLeague.dart';
import 'package:transfer_news/Widgets/StatsWidget.dart';
import 'dart:convert';

import 'package:transfer_news/Widgets/fixturecard.dart';

class eliteCallBackPage extends StatefulWidget {
  final url;

  const eliteCallBackPage({Key key, this.url}) : super(key: key);
  @override
  _eliteCallBackPageState createState() => _eliteCallBackPageState();
}

class _eliteCallBackPageState extends State<eliteCallBackPage> {
  List allFixtures;
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            eliteStandings(),
            StatsWidget(
              url: "https://www.the-aiff.com/api/competition/stats/3",
            ),
          ],
        ),
      ),
