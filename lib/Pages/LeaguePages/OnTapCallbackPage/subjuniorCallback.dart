...
import 'package:transfer_news/Pages/Standings/subJunior.dart';
import 'package:transfer_news/Widgets/StatsWidget.dart';
import 'dart:convert';

import 'package:transfer_news/Widgets/fixturecard.dart';

class subJuniorCallBackPage extends StatefulWidget {
  final url;

  const subJuniorCallBackPage({Key key, this.url}) : super(key: key);
  @override
  _subJuniorCallBackPageState createState() => _subJuniorCallBackPageState();
}

class _subJuniorCallBackPageState extends State<subJuniorCallBackPage> {
  List allFixtures;
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            SubJuniorStandings(),
            StatsWidget(
              url: "https://www.the-aiff.com/api/competition/stats/5",
            ),
          ],
        ),
      ),
