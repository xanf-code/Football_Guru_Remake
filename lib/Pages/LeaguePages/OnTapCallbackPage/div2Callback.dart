...
import 'package:transfer_news/Pages/Standings/Ileague2nd.dart';
import 'package:transfer_news/Widgets/StatsWidget.dart';
import 'dart:convert';

import 'package:transfer_news/Widgets/fixturecard.dart';

class Div2CallBackPage extends StatefulWidget {
  final url;

  const Div2CallBackPage({Key key, this.url}) : super(key: key);
  @override
  _Div2CallBackPageState createState() => _Div2CallBackPageState();
}

class _Div2CallBackPageState extends State<Div2CallBackPage> {
  List allFixtures;
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            Ileague2ndStandings(),
            StatsWidget(
              url: "https://www.the-aiff.com/api/competition/stats/6",
            ),
          ],
        ),
      ),
