              ...
              GestureDetector(
                ...
                child: ileagueFixtures.isEmpty
                    ...
                    : LeagueCard(
                        ...
                        eventVenue: ileagueFixtures[0]["status"]
                            ["startDateStr"],
                        team1Logo:
              ...
              GestureDetector(
                ...
                child: ileague2ndFixtures.isEmpty || ileague2ndFixtures == null
                    ...
                    : LeagueCard(
                        ...
                        team1Score:
                            ileague2ndFixtures[0]["team1_score"].toString(),
                        team2Logo: ileague2ndFixtures[0]["team2_logo"],
                        team2Name: ileague2ndFixtures[0]["team2_name"],
                        team2Score:
                            ileague2ndFixtures[0]["team2_score"].toString(),
                      ),
              ),
              GestureDetector(
                onTap: () {
              ...
              GestureDetector(
                ...
                child: subJuniorLeague.isEmpty
                    ...
                    : LeagueCard(
                        ...
                        team1Score:
                            subJuniorLeague[0]["team1_score"].toString(),
                        team2Logo: subJuniorLeague[0]["team2_logo"],
                        team2Name: subJuniorLeague[0]["team2_name"],
                        team2Score:
                            subJuniorLeague[0]["team2_score"].toString(),
                      ),
              ),
            ],
          );
