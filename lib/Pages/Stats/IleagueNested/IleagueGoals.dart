...
class ILeagueGoals extends StatefulWidget {
  final int data1;
  final int data2;

  const ILeagueGoals({Key key, this.data1, this.data2}) : super(key: key);
  @override
  _ILeagueGoalsState createState() => _ILeagueGoalsState();
}

class _ILeagueGoalsState extends State<ILeagueGoals>
    with AutomaticKeepAliveClientMixin<ILeagueGoals> {
  List ILeagueStats;
  ...
  Future<String> getILeagueStats() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ILeagueStats = jsonresponse["stats"][0]["leaders"];
      });
    } else {
...
//                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      ...
                      Text(
                        ILeagueStats[index]["athlete"]["statistics"][1]
                            ["displayValue"],
                        style: GoogleFonts.ubuntu(
                          color: Colors.white70,
                          fontWeight: FontWeight.bold,
